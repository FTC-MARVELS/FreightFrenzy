...
public class MAS_Auto_BlueCarousel extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        org.firstinspires.ftc.teamcode.RobotObjects.MAS.Mecanum_Wheels mecanum = new Mecanum_Wheels(hardwareMap);
        ...
        mecanum.move_backward_auto(speed,6.5, 10.0 );
        // rotate to bring spinner to position
        mecanum.rotate_anti_clock_auto(rotationSpeed, spinnerRotate, 20.0);
        ...
        mecanum.rotate_clock_auto(rotationSpeed, rotateNinety, 20.0);
        //move back a bit to scan
        mecanum.move_forward_auto(speed,4, 10.0 );
        ...
        mecanum.move_backward_auto(speed, shippingHubDistance*1.41,20.0);
        ...
        mecanum.move_forward_auto(speed,shippingHubDistance/0.95, 20.0 );
        ...
        mecanum.move_forward_auto(speed*2,ParkDistance*1.05, 25.0 );
        //else will need logic to collapse and then move right to park
        mecanum.move_right_auto(speed, shippingHubDistance*1.1, 20.0);
